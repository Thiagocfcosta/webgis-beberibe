...
export default function DashboardPanel({ activeLayers, geoData, symbologyConfig, getWorkspaceConfig, loadWorkspace, mergeWorkspace, clearMap, showToast, activeMapId }) {
